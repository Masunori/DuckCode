...
export default function Chatbox() {
    ...
    const message = useMultiplayerGameplayStore(state => state.message);
    const setMessage = useMultiplayerGameplayStore(state => state.setMessage);
    const sendMessage = useMultiplayerGameplayStore(state => state.sendMessage);
    ...
    const messageHistory = useMultiplayerGameplayStore(state => state.messageHistory);
    const addMessageToHistory = useMultiplayerGameplayStore(state => state.addMessageToHistory);
