...
const vs: monaco.editor.IStandaloneThemeData = {
	base: 'vs',
	inherit: false,
	rules: [
...
const vsDark: monaco.editor.IStandaloneThemeData = {
	base: 'vs-dark',
	inherit: false,
	rules: [
...
const hcBlack: monaco.editor.IStandaloneThemeData = {
	base: 'hc-black',
	inherit: false,
	rules: [
...
const hcWhite: monaco.editor.IStandaloneThemeData = {
	base: 'hc-light',
	inherit: false,
	rules: [
